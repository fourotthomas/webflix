            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item <?= $page === 'movies.php' ? 'active' : ''; ?>">
                        ...
                        <?php if (isset($_SESSION['user'])) { ?>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">
                                    <img src="https://unavatar.now.sh/<?= $_SESSION['user']['email']; ?>" alt="" class="rounded-circle me-2" width="30">
                                    <?= $_SESSION['user']['email']; ?>
                                </a>
                            ...
                            <li class="nav-item <?= $page === 'card.php' ? 'active' : ''; ?>">
                                <a class="nav-link" href="./card.php">Panier</a>
                            </li>
                        <?php } else { ?>
